...
const Minting_1 = __importDefault(require("../component/loading/Minting"));
const Layout_1 = __importDefault(require("./Layout"));
const ViewUtil_1 = __importDefault(require("./ViewUtil"));
class Create {
    constructor() {
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".create-view", (0, skynode_1.el)("main", (0, skynode_1.el)("h1", "Create NFTs"), (0, skynode_1.el)("section", (0, skynode_1.el)("a", (0, skynode_1.el)("h3", "Create new art"), (0, skynode_1.el)("p", "Create new NFT art Simple & Easy"), {
            click: async () => {
