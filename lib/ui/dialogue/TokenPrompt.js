...
class TokenPrompt extends Dialogue_1.default {
    constructor(title, message, confirmTitle, min, balance, confirm) {
        ...
        this.content.append((0, skynode_1.el)("p", message), this.input = (0, skynode_1.el)("input.input", { placeholder: `Balance: ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(balance))}` }), (0, skynode_1.el)("a.max-button", "Max", {
