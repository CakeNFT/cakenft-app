...
const CreateOne_1 = __importDefault(require("./view/create/CreateOne"));
const CreateUserMintNFT_1 = __importDefault(require("./view/create/CreateUserMintNFT"));
const Detail_1 = __importDefault(require("./view/Detail"));
...
const MyCollections_1 = __importDefault(require("./view/user/MyCollections"));
const MyNFTs_1 = __importDefault(require("./view/user/MyNFTs"));
