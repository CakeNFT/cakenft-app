...
interface UserMintNFTInterface extends ethers.utils.Interface {
  functions: {
    ...
    "set(string,string,string,string,uint256,uint256)": FunctionFragment;
...
export class UserMintNFT extends Contract {
  ...
  interface: UserMintNFTInterface;
  ...
  functions: {
    ...
    maxMintCount(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    set(
      ...
      _maxMintCount: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "set(string,string,string,string,uint256,uint256)"(
      name: string,
      symbol: string,
      _version: string,
      baseURI_: string,
  ...
  populateTransaction: {
    ...
    maxMintCount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
